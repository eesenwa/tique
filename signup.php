...
<div class='signupdiv' align="center" id="signupdiv">	
	...
	<div id="form_holder">
		<form id='signup_student' action="get" name='student' onsubmit="return studentValidation()">
			<input class='textfield' id='studentEmail' placeholder='Email or Phone' name='email' onkeyup="studentEmailTest()" onfocusout="studentEmailTest(); studentValidation();" autofocus> 
				<img id='studentEmailValid' src='src/invalid.png' style="visibility:hidden;">
				<br><br>
			<input type='password' id='studentPass' class='textfield' placeholder='Password' name='pass' onkeyup="studentPasswordTest()" onfocusout="studentPasswordTest(); studentValidation();">
		...
		<form id='signup_teacher' action="get" style="visibility:hidden;float:center;" onsubmit="return teacherValidation()">
			...
			<input id='ln' class='textfield' placeholder='Last name' name='lname' onkeyup="lName();" onfocusout="lName(); teacherValidation();">
				...
				<br><br>
			<input id='e' class='textfield' placeholder='Email or Phone' name='email' onkeyup="teacherEmailTest();" onfocusout="teacherEmailTest(); teacherValidation();">
				<img id='emailValid' src='src/invalid.png' style="visibility:invisible;">
				<br><br>
			<input id='p' type='password' class='textfield' placeholder='Password' name='pass' onkeyup="teacherPasswordTest()" onfocusout="teacherPasswordTest(); teacherValidation();">
				<img id='passValid' src='src/invalid.png' style="visibility:invisible;">
				<br><br>
			<input id='pc' type='password' class='textfield' placeholder='Confirm Your Password' name='pass_confirm' onkeyup="teacherPasswordConfirmTest()" onfocusout="teacherPasswordConfirmTest(); teacherValidation();">
	...
	<script> 
		...
		function teacherSubmission() {
			if(teacherValidation() || true) {
				var student_form = document.getElementById('signup_teacher');
				...
				container.children[1].style.visibility = 'visible';
		...
		function studentValidation() {
			...
			var bool = true;
			if(text_a == '' || text_b == '' || text_c == '' || text_d == '') {
				return false;
			}
